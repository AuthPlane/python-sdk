...
``authplane-mcp/authplane_mcp/url_elicitation.py`` except for the adapter name
in the docstrings and the package name in the error string below. Any fix here
— in particular the eventual mcp-2.0 elicitation-field port — must be applied to
both copies.
"""
